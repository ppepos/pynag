...
def register_properties(string_to_class, all_attributes):
...
def prepare_module_attributes(cfg, cfgf, evt_handlers, pynag_dir):

    global config, cfg_file, eventhandlers, pynag_directory
